    ...
    init: function () {
        ...
        if (hideToggle) {
            hideToggle.addEventListener('change', (e) => {
                if (e.target.checked) {
                    document.getElementById('editor-canvas').classList.add('hide-chords');
                    document.getElementById('ruby-canvas').classList.add('hide-chords'); // ✨ 同步隱藏
                } else {
                    document.getElementById('editor-canvas').classList.remove('hide-chords');
                    document.getElementById('ruby-canvas').classList.remove('hide-chords');
                }
            });
        }
    },
