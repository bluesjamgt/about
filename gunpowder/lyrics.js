const lyricsData = {
    // ==========================================
    // Album 01: MOVE ON and FIGHT
    // ==========================================
    
    // 01. Move On (已填入完整三語歌詞)
    "project/opus01-01.mp3": {
        tw: `Move On
...
Won't be astray to fight for dream`
    ...
    // 01. Prologue
    "project/opus02-01.m4a": {
        en: "(Instrumental / Soundscape)",
        tw: "(純音樂 / 聲景)",
        jp: "(インストゥルメンタル / 音風景)"
    },

    // 02. Greed
    "project/opus02-02.m4a": {
        en: `
            The greed of the soul slows down the pace of life
            Life's twists and turns sharpen the gaze
            The light in those eyes maps out the voyage

            Squandered time fills the void of loneliness
            The lonely heart momentarily pauses its beat
            Pulsing musical phrases kick away the loss
            The lost soul has finally found itself

            Overflowing emotions stack into verses
            The flow of verses weaves the melody
            The ripples of melody unveil the craving
            The heat of craving ignites the engine

            I, greedily, crave more wild experiences
            I, greedily, want to sing more soaring melodies
    ...
    "project/opus02-03.m4a": {
        ...
        Smile on my face.
        Forever, right here I'll wait.
        Even no, no words you...

        You pour me whole glass of rain,
        with bloody red. I drink up the pain.
        tears on my face.
        Forever, right here I'll wait.
        Even no, no words you left.`,
        tw: `
...
/**
 * 取得歌詞的輔助函式
 * @param {string} filePath - 音樂檔案路徑 (作為 ID)
 * @param {string} lang - 當前語言代碼 (en/tw/jp)
 * @returns {string} 對應的歌詞，如果找不到則回傳空字串
 */
function getLyrics(filePath, lang) {
    if (lyricsData[filePath]) {
        // 優先回傳當前語言，如果沒有則回傳英文，再沒有回傳預設文字
        return lyricsData[filePath][lang] || lyricsData[filePath]['en'] || "No Lyrics Available.";
    }
    return "";
}